...
[BEGIN_COT_EXT]
Hooks=index.tags
Tags={BF3S_INDEX}:index
[END_COT_EXT]
==================== */

/**
 * Shows BF3 server information
 *
...
$t1 = new XTemplate(cot_tplfile('bf3server.index', 'plug'));
...
$t1->parse('MAIN');
$bf3server = $t1->text('MAIN');
$t->assign(array('BF3S_INDEX' => $bf3server));
